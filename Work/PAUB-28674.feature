...
Scenario: Enter New Policy Manager Details for "E2ETest_Category_ServiceExcludeURIs_NintendoCom"
Given "RandomNumber" default value is "{date('YYYYMMDDmmss')}"
Given "CategoryName" default value is "E2ETest_Category_ServiceExcludeURIs_NintendoCom_{RandomNumber}"
When I set "Add Category Form Name" value to "{CategoryName}"
And I set "Add Category Form Type" value to "Service: Exclude URIs"
Then I should see "{CategoryName}" in "Add Category Form Name"
And I should see "Service: Exclude URIs" in "Add Category Form Type"

Scenario: Type or select nintendo.com on the box, to indicate the target you wish to add
When I set "Add Category URI Input" value to "nintendo.com"
And I press "ENTER"
Then I should see "nintendo.com" in "First Item above URI Textbox"
