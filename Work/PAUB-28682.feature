...
Scenario: Enter New Policy Manager Details for "E2ETest_Category_DeviceMatchUserAgents_Mozilla"
Given "RandomNumber" default value is "{date('YYYYMMDDmmss')}"
Given "CategoryName" default value is "E2ETest_Category_DeviceMatchUserAgents_Mozilla_{RandomNumber}"
