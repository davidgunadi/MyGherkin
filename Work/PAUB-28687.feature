...
Scenario: Create "E2ETest_Policy_BandwidthLimit_10Mbps"
Given "RandomNumber" default value is "{date('YYYYMMDDmmss')}"
Given "PolicyName" default value is "E2ETest_Policy_BandwidthLimit_10Mbps_{RandomNumber}"
Given "BandwidthLimitValue" default value is "10"
