...
"""
Then commands should complete successfully
And "Loader l_hexis_hawkeye_analyzerAudit_syslogng: enabled" should be in output
...
"""
Then commands should complete successfully
And "Retriever Statistics:" should be in output
