...
Scenario: Enter New Policy Manager Details for "E2ETest_Category_ServiceMatchProtocols_Bittorrent"
Given "RandomNumber" default value is "{date('YYYYMMDDmmss')}"
Given "CategoryName" default value is "E2ETest_Category_ServiceMatchProtocols_Bittorrent_{RandomNumber}"
...
Scenario: Type or select Bittorrent on the box, to indicate the target you wish to add
