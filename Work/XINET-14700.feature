...
When I execute GET request for "{environment.SERVER.URL}/webnative/portalDI?action=version&debug=true"
...
Then I should see "{TimeStamp}" in "Logs (in Logging Page)"
And I should see "portalDI: Request values - name | val = [ action | version ]" in "Logs (in Logging Page)"
