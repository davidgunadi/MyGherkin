...
And I type slowly "BEC-63_{currentDateTime}"
And I press "TAB"
And I click on "Dashboard Description (in Create Page)"
And I type slowly "Desc_{currentDateTime}"
And I press "TAB"
Then I should see "BEC-63_{currentDateTime}" in "Dashboard Title (in Create Page)"
...
And I type slowly "Text Card BEC-63"
And I click on "Save button in add text card popup"
Then I should see "Text Card BEC-63" in "First Text Card in Dashboard (in Create Page)"