...
When I set "TestOrganization1" to "Name (in Create New Form)" value
And I click on "Appointing Company Checkbox (in Create New Form)"
And I click on "Contract Kit Provider Checkbox (in Create New Form)"
And I click on "Distributor Checkbox (in Create New Form)"
And I set "{TaxID}" to "Tax ID/SSN (in Create New Form)" value
And I click on "Synchronize with PDB (in Create New Form)"
And I click on "No (Dropdown Option)"
And I click on "Agency Formation Date (in Create New Form)"
And I type "{currentDateInMMDDYYYY}"
And I set "1234" to "DTCC ID (in Create New Form)" value
And I set "123456" to "National Producer Number (in Create New Form)" value
And I set "Entrepreneur" to "Doing Business As (in Create New Form)" value
And I click on "Comm Mode to Try First (in Create New Form)"
And I click on "Mailing (Dropdown Option)"
And I set "1234,NE" to "Street1 (in Create New Form)" value
And I set "Wall Street" to "Street2 (in Create New Form)" value
And I set "Aden" to "Street3 (in Create New Form)" value
And I set "Utah" to "City (in Create New Form)" value
And I set "112332" to "ZipCode (in Create New Form)" value
And I set "9988776655" to "Phone Number (in Create New Form)" value
And I set "9988776655" to "Cell Phone Number (in Create New Form)" value
And I set "12323442" to "Fax Number (in Create New Form)" value
And I set "asd@test.com" to "Email Address (in Create New Form)" value
And I set "23211" to "Pager Number (in Create New Form)" value
